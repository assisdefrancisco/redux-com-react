...
const tokenFetchSuccess = (token) => ({ type: TOKEN_FETCH_SUCCESS, payload: token, localStorage: 'token' });
const tokenFetchError = (message) => ({ type: TOKEN_FETCH_ERROR, payload: message });
